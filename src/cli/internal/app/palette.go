...
func every4Palette(keys keymap) []command {
	return []command{
		...
		{title: "database and schemas", key: keys.Catalog.Help().Key,
			msg: catalogNowMsg{}},
		{title: "connections", key: keys.Connections.Help().Key, msg: switchMsg{}},
		...
		{title: "explain the statement", key: keys.Explain.Help().Key, where: onEditor,
			msg: explainMsg{}},
		{title: "cancel the statement in this tab", key: keys.Stop4Query.Help().Key,
			where: onEditor, msg: haltMsg{}},
